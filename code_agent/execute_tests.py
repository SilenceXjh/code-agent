...
def main():
    ...
    parser.add_argument('--test-dir', default='/data1/xjh/code-agent/data/qwen-coder-32B/generations',
                        help='测试文件目录')
    parser.add_argument('--metadata', default='/data1/xjh/code-agent/data/qwen-coder-32B/generation_metadata.jsonl',
                        help='元数据文件路径')
    parser.add_argument('--output', default='/data1/xjh/code-agent/data/qwen-coder-32B/test_results.jsonl',
                        help='结果输出路径')
    parser.add_argument('--summary', default='/data1/xjh/code-agent/data/qwen-coder-32B/test_summary.json',
                        help='摘要输出路径')
